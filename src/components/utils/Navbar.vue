        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0  bg-gray-800 md:bg-gray-900 border-gray-700">
                    <li>
                        <router-link :to="{name: 'heroes'}" class="block py-2 px-3 rounded-sm bg-gray-100 md:bg-transparent md:border-0 md:p-0 text-gray-300 hover:bg-gray-700 hover:text-white md:hover:bg-transparent">Heroes</router-link>
                    </li>
                    <li>
                        <router-link :to="{name: 'pruebas'}" class="block py-2 px-3 rounded-sm bg-gray-100 md:bg-transparent md:border-0 md:p-0 text-gray-300 hover:bg-gray-700 hover:text-white md:hover:bg-transparent">Pentatlón</router-link>
                    </li>
                </ul>
            </div>
        </div>
